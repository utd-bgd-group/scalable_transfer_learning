...
def main():
    ...
    parser.add_argument("-s", "--bag_size", type=int, default=600, help="the sample size")
    ...
    bag_size = args.bag_size # the bag_size
    ...
    # statistics
    statistics = "mode=%s, train_size=%i, test_size=%i, bag_size=%i, m=%i, n=%i\n" % (mode, len(train_data), len(test_data), bag_size, m, n)
